...
le09:
	...
	decktape automatic --chrome-arg=--no-sandbox -s 1290x960 slides/lecture_09.html slides/lecture_09.pdf
...
le11:
	...
	decktape automatic --chrome-arg=--no-sandbox -s 1280x960 slides/lecture_11.html slides/lecture_11.pdf
